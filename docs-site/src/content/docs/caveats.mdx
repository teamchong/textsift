---
title: Caveats
description: What pii-wasm does well, and what it doesn't.
---
...
`pii-wasm` is a production-grade inference engine for a model that itself is an aid, not an anonymization guarantee. Treat it as such.
